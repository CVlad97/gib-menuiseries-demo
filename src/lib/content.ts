...
> = {
  portail: {
    ...
    gradient: 'linear-gradient(135deg, #2b2118 0%, #9b6a34 48%, #e6c17d 100%)',
    border: '#c8944f',
    ink: '#fff6e3',
  },
  fenetre: {
  ...
  'volet-roulant': {
    ...
    gradient: 'linear-gradient(135deg, #1e2b31 0%, #536b70 45%, #f2cf77 100%)',
    border: '#819199',
    ink: '#fff9df',
  },
  pergola: {
    ...
    tone: 'Sauge terrasse',
    gradient: 'linear-gradient(135deg, #31483d 0%, #7fb28a 50%, #f4d178 100%)',
    border: '#8dbb8f',
    ink: '#f7ffe9',
  },
  cloture: {
    ...
    tone: 'Terre facade',
    gradient: 'linear-gradient(135deg, #5a3926 0%, #b57a42 50%, #d8c6a4 100%)',
    border: '#b9824f',
    ink: '#fff2de',
  },
  'garde-corps': {
    ...
    tone: 'Acier clair',
    gradient: 'linear-gradient(135deg, #25333a 0%, #8aa2a8 46%, #e6dcc7 100%)',
    border: '#9aaeb2',
    ink: '#f8fbfb',
  },
  renovation: {
    ...
    gradient: 'linear-gradient(135deg, #3c3028 0%, #a8855f 48%, #e7d4b8 100%)',
    border: '#b99873',
    ink: '#fff5e8',
  },
  depannage: {
    ...
    tone: 'Signal rapide',
    gradient: 'linear-gradient(135deg, #48221f 0%, #d6533b 46%, #ffd27a 100%)',
    border: '#e06a4f',
    ink: '#fff2e6',
  },
  'projet-pro': {
    ...
    gradient: 'linear-gradient(135deg, #182d3b 0%, #346d8c 48%, #b9d6d0 100%)',
    border: '#4b8daa',
    ink: '#eefbff',
  },
}
